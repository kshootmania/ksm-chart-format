...
- The behavior for illegal values is undefined, and kson clients do not necessarily need to stop reading the kson file as an error even if there is an illegal value.
